  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 container py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold">Projects for Developers</h1>
          <p className="text-gray-500">Browse available projects and submit your bids</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project) => (
            <Link href={`/projects/${project.id}/developer-view`} key={project.id}>
